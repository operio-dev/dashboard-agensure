      ...
      <div className="relative z-10 backdrop-blur-md bg-[color-mix(in_oklab,var(--background)_55%,transparent)] border-t hairline p-8 md:p-12">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-sm md:text-base text-muted-foreground leading-relaxed">
            Upgrade to Premium Tier to unlock the full <span className="text-foreground font-semibold">10,000 adversarial probe matrix</span> on-demand before major production deploys.
          </p>
          ...
          <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-2">
            <button className="group inline-flex items-center justify-center gap-2 rounded-md bg-[var(--success)] px-5 py-2.5 text-sm font-semibold text-[var(--success-foreground)] hover:brightness-110 transition shadow-[0_8px_30px_-10px_color-mix(in_oklab,var(--success)_60%,transparent)]">
